...
const RISK_CARDS = [
  { num: 1, title: 'Location Information', headerBg: 'bg-blue-600', examples: 'Addresses, street signs, house numbers.', image: mapImage },
  { num: 2, title: 'School Identity', headerBg: 'bg-green-600', examples: 'School names, logos, uniforms.', image: schoolImage },
  { num: 3, title: 'Personal Identifiers', headerBg: 'bg-amber-500', examples: 'Full names, birthdates, IDs.', image: passportImage },
  { num: 4, title: 'Daily Routines & Schedules', headerBg: 'bg-purple-600', examples: 'Class schedules, practice times.', image: scheduleImage },
  { num: 5, title: 'Family & Home', headerBg: 'bg-red-600', examples: 'License plates, family info.', image: familyImage },
]
...
function InstructionPopup({ onContinue }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      />
      <div
        className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl border-2 border-amber-200 bg-amber-50/95 shadow-xl"
        role="dialog"
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="relative">
            <div className="pr-28 md:pr-36">
              <h1 id="instruction-popup-title" className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              ...
              <div className="flex items-center gap-2 text-gray-700 font-medium">
                ...
                <span className="text-lg">Look closely – some risks are hidden in plain sight!</span>
              </div>
            </div>
            <img src={shieldlogo} alt="" className="absolute top-0 right-0 w-30 h-30 object-contain" aria-hidden />
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-3 text-lg">
              Find unsafe posts across all 5 privacy-risk categories and learn how to fix them before someone else can use that information.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed text-lg">
                  You&apos;re viewing this now because you clicked the rules icon on the right! Click it anytime during the game to pause and review. The timer stops while paused—helpful if you need a quick reminder of the 5 risk categories or how to play.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-stretch">
              {RISK_CARDS.map((card) => (
                ...
                >
                  <div className={`${card.headerBg} shrink-0 min-h-14 flex items-center justify-center px-2 py-2 text-center`}>
                    <p className="text-white font-semibold text-sm leading-tight">
                      {card.num} {card.title}
                    </p>
                  </div>
                  <div className="shrink-0 h-28 flex justify-center items-center bg-amber-50/50 py-2">
                    <img src={card.image} alt="" className="max-h-full max-w-full object-contain" aria-hidden />
                  </div>
